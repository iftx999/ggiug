...
from service.validacao_service import criar_validacao_com_versao, listar_validacoes_por_projeto
...
def testar_validacao_destino(validacao_id: int, db: Session = Depends(get_db)):
    return executar_validacao_somente_destino(validacao_id, db)
